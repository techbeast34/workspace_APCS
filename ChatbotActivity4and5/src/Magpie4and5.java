...
public class Magpie4and5
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "Would you really be happy if you had" + statement.trim().replace("I want", "").replace(".", "") + "?";
		}
		else if(findKeyword(statement, "I", 0) >= 0 && findKeyword(statement, "you", 0) >=0)
		{
			response = "Why do you" + statement.trim().replace("I", "").replace("you", "").replace(".", "") + "me?";
		}
		else
		{
